      ...
      <section class="section section-lg bg-gray-1 text-center">
        <div class="container">
          ...
          <div class="row row-30">
            <div class="col-6 col-md-3"><a class="clients-default" href="#"><img src="images/html.png" alt="" width="270" height="119"/></a></div>
            <div class="col-6 col-md-3"><a class="clients-default" href="#"><img src="images/php.png" alt="" width="270" height="119"/></a></div>
            <div class="col-6 col-md-3"><a class="clients-default" href="#"><img src="images/Java.png" alt="" width="270" height="119"/></a></div>
            <div class="col-6 col-md-3"><a class="clients-default" href="#"><img src="images/CSS.png" alt="" width="270" height="119"/></a></div>
          </div>
          <br>
          <br>
          <h2>Aplikasi Yang Kita Gunakan :</h2>
          <div class="row row-30">
            <div class="col-6 col-md-3"><a class="clients-default" href="#"><img src="images/Canva.png" alt="" width="270" height="119"/></a></div>
            <div class="col-6 col-md-3"><a class="clients-default" href="#"><img src="images/Vscode.png" alt="" width="270" height="119"/></a></div>
          </div>
        </div>
      </section>
      </main>
